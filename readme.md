...
〓<t class="t_gl" contenteditable="false">2025/08/21 16:10</t> Update Details〓

Fixes an issue whereby leaving the corresponding area in Tete Isle when playing "Revisit the Opening Ceremony" causes the game to be unable to adjust the time.

Travelers affected by this issue can log out via the Paimon Menu and close the game, then log in again.

〓<t class="t_gl" contenteditable="false">2025/08/14 16:15</t> Update Details〓

- Fixes an issue whereby there is a localization error in German for the Recommended Tags description of Battlefield 2: "Battle-Hardened Tent Tortoise" in the "Stygian Onslaught" event.
...
# [Version Satisfaction Survey Now Open](archive/21323.md)
...
2025/09/05 10:00:00 (global) - 2025/09/08 23:59:59 (global)

〓Survey Address〓

[Click here to fill out the survey](https://webstatic.hoyoverse.com/common/event/survey-user-v2/index.html?auth_appid=survey_CNn_iUB6sh-seXZlJUP2c9jil7qIbTGnVMFkKjT6h-4IVAO&game_biz=hk4e_global&surveyId=33513&format=1&sign_type=2&authkey_ver=1)
